        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-8 pt-20 sm:pt-32 pb-20 sm:pb-28">
          <div className="max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/proposals/new" className="px-8 py-4 bg-red-700 text-white font-bold text-lg hover:bg-red-600 transition-colors inline-flex items-center justify-center gap-2 shadow-lg shadow-red-700/20">
                Parse an RFP
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative py-16 sm:py-24 px-4 sm:px-8 text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/proposals/new" className="px-8 py-4 bg-red-700 text-white font-bold text-lg hover:bg-red-600 transition-colors inline-flex items-center justify-center gap-2 shadow-lg shadow-red-900/30">
              Start Winning
              <ArrowRight className="w-5 h-5" />
            </Link>
            <Link to="/proposals" className="px-8 py-4 bg-white text-blue-900 font-bold text-lg hover:bg-blue-50 transition-colors shadow-lg inline-flex items-center justify-center">
              View Proposals
            </Link>
          </div>
        </div>
